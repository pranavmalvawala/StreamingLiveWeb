        ...
        <>
            ...
            <div className="container">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to StreamingLive, accessible from <a href="https://streaminglive.church" rel="noopener noreferrer" target="_blank">https://streaminglive.church</a></p>
                    </li>
                    <li>
